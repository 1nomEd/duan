...
<head>
	...
	<title>MAY | Có gì khó, đến M A Y </title>
				...
				<div class="container">
					<div class="row small-gutters">
						<div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
							<div id="logo">
								<a href="index.php"><img src="View/img/logoo.png" alt="" width="100" height="100"></a>
							</div>
						</div>
						<nav class="col-xl-6 col-lg-7">
							...
							<div class="main-menu">
								<div id="header_menu">
									<a href="index.php"><img src="View/img/logoo.png" alt="" width="100"
											height="35"></a>
						...
						<div class="col-xl-3 col-lg-2 d-lg-flex align-items-center justify-content-end text-end">
							<a class="phone_top" href="tel://0343014882"><strong><span>Cần Hỗ Trợ</span>0822086992
								</strong></a>
						</div>
					</div>
					<!-- /row -->
